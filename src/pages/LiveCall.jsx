...
export default function LiveCall() {
  ...
  // Called by DeepgramTranscript each time a new entry arrives
  const handleTranscriptEntry = useCallback(async (entry) => {
    fullTranscriptRef.current = [...fullTranscriptRef.current, entry];

    // Only analyze customer speech or every 3rd agent line
...
const startCall = async () => {
  ...
  //   status: "live",
  //   lead_name: leadInfo.name || "New Lead",
